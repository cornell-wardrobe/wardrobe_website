      ...
      <div className="h-[75vh] xs:h-screen grid grid-rows-2 gap-0 bg-slate-100 lg:flex lg:columns-2">
        <div className="flex h-full items-center justify-center lg:justify-normal">
          <div className="md:mb-24 lg:mb-0 lg:ml-32 xl:ml-56 text-center lg:text-left">
            ...
            <p className="text-xl  med:text-2xl">Register now for the Spring 2026 Pop-Up Shop!</p>
            <p className="text-lg med:text-2xl italic">Physical Sciences Building Atrium</p>
            <p className="text-lg med:text-2xl italic">@11AM - 1PM</p>
            <Link to="https://cglink.me/2ee/r2302935" target="blank">
